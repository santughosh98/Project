...
(7)POST /login
Allow an author to login with their email and password. On a successful login attempt return a JWT token containing the authorId in response body like this
